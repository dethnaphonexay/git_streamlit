...
if not tplus_data.empty:
    ...
    service_col1.metric("Total Fee Estimate MBB", f"{tplus_data['total_fee_charge_mbb'].sum():,}")
    service_col2.metric("Total Fee Collected MBB", f"{tplus_data['total_collected_fee_mbb'].sum():,}")
    service_col3.metric("Total Fee Estimate FBB", f"{tplus_data['total_fee_charge_fbb'].sum():,}")
    service_col4.metric("Total Fee Collected FBB", f"{tplus_data['total_collected_fee_fbb'].sum():,}")
